...
function draw() {
  ...
  if (currentState === "screen1") {
    image(text1, width/6, height/5, dbox.width/6, dbox.height/6);
    if (!audio1.isPlaying()) {
      audio1.play();
    }
  } else if (currentState === "screen2") {
    image(text2, width/6, height/5, dbox.width/6, dbox.height/6);
    if (!audio2.isPlaying()) {
      audio2.play();
    }
    ...
    image(text3, width/6, height/5, dbox.width/6, dbox.height/6);
    if (!audio3.isPlaying()) {
      audio3.play();
    }
    ...
    image(text4, width/6, height/5, dbox.width/6, dbox.height/6);
    if (!audio4.isPlaying()) {
      audio4.play();
    }
    ...
    userStartAudio();
    micIn.start();
    image(text2, width/6, height-900, dbox.width/6, dbox.height/6);
  }

  else if (currentState === "screen6") {
    image(text5, width/6, height/5, dbox.width/6, dbox.height/6);
    if (!audio5.isPlaying()) {
      audio5.play();
    }
    ...
    image(text7, width/6, height/5, dbox.width/6, dbox.height/6);
    ...
    image(text8, width/6, height/5, dbox.width/6, dbox.height/6);
